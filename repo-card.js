// https://github.com/tarptaeya/repo-card/tree/master
  ...
  for (const el of document.querySelectorAll('.repo-card')) {
    ...
    <div class="container" onclick="window.open('${data.html_url}', '_blank');">
      ...
      <div style="font-size: 12px; color: ${theme.color}; display: flex;">
        ...
        <div style="display: ${data.stargazers_count}; align-items: center; margin-right: 16px;">
        ...
        <div style="display: ${data.forks}; align-items: center;">
